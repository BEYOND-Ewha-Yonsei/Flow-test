  ...
  await handleTransaction('Sending transaction...', [
      ...
      transaction(address: Address) {
          ...
          prepare(acct: AuthAccount) {
              ...
              self.transferToken <- collectionRef.withdraw(withdrawID: 5) // set "withdrawID" as a variable
              self.getMetadataRef = collectionRef.getMetadata(id: 5) // set "id" as a variable
          }
